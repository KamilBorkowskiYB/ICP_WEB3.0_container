...
import { idlFactory } from './icp_bootcamp_project_backend.did.js';
export { idlFactory } from './icp_bootcamp_project_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ICP_BOOTCAMP_PROJECT_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icp_bootcamp_project_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icp_bootcamp_project_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icp_bootcamp_project_backend.did.js")._SERVICE>}
 */
export const icp_bootcamp_project_backend = createActor(canisterId);
